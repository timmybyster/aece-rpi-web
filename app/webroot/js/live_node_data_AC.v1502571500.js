...
function preload(){
	...
	game.load.spritesheet('infowindow', $('#cnfRoute').val() + '/img/infoWindow.png', 100, 100);
	game.load.spritesheet('ccb', $('#cnfRoute').val() + '/img/ccb.png', 100, 100);
	game.load.spritesheet('cbb', $('#cnfRoute').val() + '/img/cbb.png', 100, 100);
