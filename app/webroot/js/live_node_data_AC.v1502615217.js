...
function createNodeVisual(node){
	...
	nodeVisual.events.onInputDown.add(goToDetonators, this);
...
function goToDetonators(sprite, pointer){
	...
	path = "detonators/" + sprite.db_id;
	open(path, "_blank", "channelmode=yes,fullscreen=no,height=300,width=300,titlebar=no,status=no,menubar=no,toolbar=no,scrollbars=no");
}
