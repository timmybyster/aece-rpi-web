...
$(document).ready(function() {
    ...
    game = new Phaser.Game(window.innerHeight * window.devicePixelRatio - 50, window.innerWidth * window.devicePixelRatio - 50, Phaser.CANVAS, 'live_div', {preload: preload, create: create, update: update, render: render});
...
function create(){
	...
	infoWindow = game.add.sprite(0, 0, 'infowindow');
}
function update(){
