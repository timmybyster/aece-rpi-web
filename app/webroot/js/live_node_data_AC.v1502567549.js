...
function preload(){
	...
	game.load.spritesheet('ccb', $('#cnfRoute').val() + '/img/ccb.png', 10, 10);
	game.load.spritesheet('cbb', $('#cnfRoute').val() + '/img/cbb.png', 10, 10);
}
...
function createNodeVisual(node){
	...
	switch(parseInt(node.type_id)){
		case 0 :
			...
			nodeVisual = game.add.sprite(0, 0, 'infowindow');
			break;
			
		case 3 :
			nodeVisual = game.add.sprite(0, 0, 'cbb');
			break;
	}
