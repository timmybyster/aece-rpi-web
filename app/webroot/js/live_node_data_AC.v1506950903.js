...
function preload(){
	...
	game.load.image('fault', $('#cnfRoute').val() + '/img/fault.png', 100, 100);
	game.load.image('warning', $('#cnfRoute').val() + '/img/warning.png', 50, 50);
}
...
function createNodeVisual(node){
	...
	faultDisplay = game.add.sprite(-20, -30, 'fault', 0);
	warning = game.add.sprite(-20, -30, 'warning', 0);
