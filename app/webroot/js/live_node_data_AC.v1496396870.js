...
function showInfoWindow(sprite, pointer) {
	...
	infoWindow.width = infoWindow.width/(zoom*1.5);
	infoWindow.height = infoWindow.height/(zoom*1.5);
...
function createNodeVisuals() {
	...
	if (node['type'] === 'IB651') {
      ...
      if(nodeVisual.type_id == 4){
		  text2 = game.add.text(0,85,ip_text,0);
		  text3 = game.add.text(0,85,ip_text,0);
		  text4 = game.add.text(-50,60,node['comment'],0);
		  text5 = game.add.text(-50,85,"IP:",0);
	  }
	  else{
