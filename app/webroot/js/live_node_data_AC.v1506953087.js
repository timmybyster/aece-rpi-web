...
function createCbb(node){
	...
	var warning = game.add.sprite(-14, -25, 'warning', 0);

	cbb.addChild(faultDisplay);
	cbb.addChild(warning);
	
	cbb.state = "ok";
	
	bad_col = Phaser.Color.toRGBA(255, 255, 255, 255);
